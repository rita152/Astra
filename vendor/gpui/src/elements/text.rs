...
impl TextLayout {
    fn layout(
        ...
        // CSS retains fractional leading; snapping each line turns 22.75px
        // into 23px and accumulates drift down a paragraph.
        #[cfg(not(target_os = "macos"))]
        let line_height = window.pixel_snap(line_height);
